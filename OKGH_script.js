document.addEventListener("DOMContentLoaded", function () {
  fetch("OKGH-fileList.xlsx")
    ...
    .then((data) => {
      ...
      const anchorElements = document.querySelectorAll("#OKGH-fileList li a"); // Target only anchor elements
      ...
      anchorElements.forEach(function (linkElement) {
        linkElement.addEventListener("mouseenter", function (event) {
          ...
          if (paragraph) {
            ...
            video.src = `./videos/OKGH/${listItemText}.mp4`; // Assuming the ID is the video name
            video.controls = true;
            ...
            paragraphCanvas.style.left = event.pageX - 550 + "px";
            paragraphCanvas.style.top = event.pageY + 5 + "px";
