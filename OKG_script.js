document.addEventListener("DOMContentLoaded", function () {
  fetch("OKG-fileList.xlsx")
    ...
    .then((data) => {
      ...
      const anchorElements = document.querySelectorAll("#OKG-fileList li a"); // Target only anchor elements
      ...
      anchorElements.forEach(function (linkElement) {
        linkElement.addEventListener("mouseenter", function (event) {
          ...
          if (paragraph) {
            ...
            video.src = `../videos/OKG/${listItemText}.mp4`; // Assuming the ID is the video name
            video.controls = true;
